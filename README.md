...
|------------------------------------|-----------------|----------------------------|----------------|---------------|
| AC 5P8 In Power                    | 4G Wireless     | AC 5P8 Charging Speed      | Operating Mode | Unpause Solar |
| AC 5P8 Out Power.            ¹     | AC Always On    | AC Always On Minimum Level |                |               |
| AC C20 In Power                  ¹ | AC Ports        | AC C20 Charging Speed      |                |               |
| AC L1 (1) Out Power                | AC X-Boost      | AC Timeout                 |                |               |
| AC L1 (2) Out Power                | Battery Heating | Backup Reserve Level       |                |               |
| AC L2 (1) Out Power                | DC Ports        | Charge Limit               |                |               |
| AC L2 (2) Out Power                |                 | DC Timeout                 |                |               |
| AC L14 Out Power                   |                 |.Device Timeout             |                |               |
| AC TT Out Power                    |                 | Discharge Limit            |                |               |
| Anderson Out Power                 |                 | LCD Screen Timeout         |                |               |
| Battery Level                      |                 |                            |                |               |
...
| BMS Output Power                   |                 |                            |                |               |
| Charge Reign State                 |                 |                            |                |               |
| EMS Max Available Number           |                 |                            |                |               |
| EMS Open BMS Index                 |                 |                            |                |               |
| EMS Para Max Voltage               |                 |                            |                |               |
| EMS Para Min Voltage               |                 |                            |                |               |
| EMS Work State                     |                 |                            |                |               |
| EV Max Charger Current             |                 |                            |                |               |
| Fan State                          |                 |                            |                |               |
| HV Solar Current                   |                 |                            |                |               |
| HV Solar Error Code                |                 |                            |                |               |
